...
export const BottomSheet = ({
  ...
  const animatedSheetStyle = useAnimatedStyle(() => {
    const borderRadius = interpolate(translateY.value, [SNAP_TOP, SNAP_TOP + 50], [0, RADII.xl], Extrapolate.CLAMP);
    return {
      transform: [{
  ...
  return <Animated.View style={[styles.bottomSheet, animatedSheetStyle, {
    height: sheetHeight
  }]}>
