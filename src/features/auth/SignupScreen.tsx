            ...
            paddingBottom: keyboardVisible ? 240 : insets.bottom + 24
              ...
              <View style={[styles.mainContent, dynamicPadding]}>
                ...
                <View style={styles.inputContainer}>
                  ...
                  <View style={[styles.inputWrapper, fullNameFocused && styles.inputWrapperFocused, errors.fullName && styles.inputWrapperError]}>
                  ...
                  }) => <TextInput style={styles.textInput} placeholder="Full Name" placeholderTextColor="#c8c6c5" autoCapitalize="words" autoCorrect={false} value={value} onChangeText={onChange} onBlur={() => {
                    onBlur();
                    setFullNameFocused(false);
                  }} onFocus={() => setFullNameFocused(true)} returnKeyType="next" onSubmitEditing={() => emailInputRef.current?.focus()} />} />
                  </View>
                ...
                <View style={styles.inputContainer}>
                  ...
                  }) => <TextInput ref={emailInputRef} style={styles.textInput} placeholder="Enter your email" placeholderTextColor="#c8c6c5" keyboardType="email-address" autoCapitalize="none" autoCorrect={false} value={value} onChangeText={onChange} onBlur={() => {
                    onBlur();
                ...
                <View style={styles.inputContainer}>
                  ...
                  }) => <TextInput ref={passwordInputRef} style={styles.textInput} placeholder="Enter password" placeholderTextColor="#c8c6c5" secureTextEntry={!showPassword} autoCapitalize="none" autoCorrect={false} value={value} onChangeText={onChange} onBlur={() => {
                    onBlur();
                    setPasswordFocused(false);
                  }} onFocus={() => setPasswordFocused(true)} returnKeyType="next" onSubmitEditing={() => confirmPasswordInputRef.current?.focus()} />} />
                    <TouchableOpacity style={styles.visibilityToggle} onPress={() => setShowPassword(!showPassword)} activeOpacity={0.7}>
                      <MaterialIcons name={showPassword ? "visibility" : "visibility-off"} size={20} color="#5f5e5e" />
                    </TouchableOpacity>
                  </View>
                ...
                <View style={styles.inputContainer}>
                  ...
                  <View style={[styles.inputWrapper, confirmPasswordFocused && styles.inputWrapperFocused, errors.confirmPassword && styles.inputWrapperError]}>
                    <MaterialIcons name="lock" size={20} color="#5f5e5e" style={styles.inputIcon} />
                  ...
                  }) => <TextInput ref={confirmPasswordInputRef} style={styles.textInput} placeholder="Confirm Password" placeholderTextColor="#c8c6c5" secureTextEntry={!showConfirmPassword} autoCapitalize="none" autoCorrect={false} value={value} onChangeText={onChange} onBlur={() => {
                    onBlur();
                    setConfirmPasswordFocused(false);
                  }} onFocus={() => setConfirmPasswordFocused(true)} returnKeyType="done" onSubmitEditing={handleSignupSubmit} />} />
                    <TouchableOpacity style={styles.visibilityToggle} onPress={() => setShowConfirmPassword(!showConfirmPassword)} activeOpacity={0.7}>
                      <MaterialIcons name={showConfirmPassword ? "visibility" : "visibility-off"} size={20} color="#5f5e5e" />
                    </TouchableOpacity>
                  </View>
                ...
                <View style={styles.termsContainer}>
                  <Controller control={control} name="terms" render={({
                  field: {
                    onChange,
                    value
                  }
                }) => <TouchableOpacity style={styles.checkboxWrapper} onPress={() => onChange(!value)} activeOpacity={0.8}>
                        <View style={[styles.checkbox, value && styles.checkboxChecked]}>
                          {value && <MaterialIcons name="check" size={16} color={COLORS.white} />}
                        </View>
                ...
                <View style={styles.actionsGroup}>
                  {}
                  <PrimaryButton title="Sign Up" onPress={handleSignupSubmit} loading={loading} disabled={loading} activeOpacity={0.9} iconElement={<MaterialIcons name="arrow-forward" size={20} color={COLORS.white} />} iconPosition="right" />
