...
const EV_STATIONS = [
  { id: '1', name: 'EESL', status: '0/0 AVAIL', distance: '9.47 KM', address: 'Double Story Market, Maherchand L...', supports: '', lat: 28.5850, lng: 77.2340 },
  { id: '2', name: 'EESL', status: '0/0 AVAIL', distance: '12.1 KM', address: 'Palika Gate No. 2, Connaught Place', supports: '', lat: 28.6320, lng: 77.2180 },
];
          ...
          <View style={styles.headerOverlayColor}>
            <SafeAreaView style={{ flex: 1 }} edges={['top']}>
              ...
              <View style={styles.searchBox}>
                <MaterialCommunityIcons name="magnify" size={26} color="white" style={{ marginLeft: 15 }} />
                <TextInput 
      ...
      <View style={styles.contentOverlay} pointerEvents="box-none">
        ...
        <View style={styles.bottomSheet}>
          <View style={styles.tabBar}>
             <TouchableOpacity 
               style={[styles.tabBtn, activeTab === 'EV' ? styles.activeEv : styles.inactiveTab]}
             ...
             <TouchableOpacity 
               style={[styles.tabBtn, activeTab === 'Parking' ? styles.activeParking : styles.inactiveTab]}
               onPress={() => setActiveTab('Parking')}
             >
                <MaterialCommunityIcons name="alpha-p-circle" size={22} color="#E67E22" />
                <Text style={[styles.tabLabel, { color: '#333' }]}>Parking Spots</Text>
             </TouchableOpacity>
          </View>
...
const styles = StyleSheet.create({
  ...
  bottomSheet: { 
    ...
    paddingTop: 20, paddingBottom: 25, elevation: 20
  },
  tabBar: { flexDirection: 'row', paddingHorizontal: 20, gap: 15, marginBottom: 25 },
  tabBtn: { 
    flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    height: 55, borderRadius: 28, elevation: 2
  },
  activeEv: { backgroundColor: '#C0392B' },
  activeParking: { backgroundColor: '#f0f0f0', borderWidth: 1, borderColor: '#ddd' },
