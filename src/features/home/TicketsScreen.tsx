...
export const TicketsScreen: React.FC<TicketsScreenProps> = ({
  ...
  useEffect(() => {
    const blinkLoop = Animated.loop(Animated.sequence([Animated.timing(blinkAnim, {
      toValue: 0.1,
      duration: 700,
  ...
  return <Screen noPadding backgroundColor="#F5F5F5" scrollable>
      <View style={styles.headerIllustration}>
        <Image source={require("../../../assets/images/transit_header.webp")} style={styles.illustrationImg} contentFit="cover" transition={500} />
      </View>

      <View style={styles.mainContent}>
        {}
        <View style={styles.gridContainer}>
          <TouchableOpacity style={styles.actionCard} onPress={() => (navigation as any).navigate("BookingStack", {
          screen: "Booking"
        })}>
            <Text style={styles.actionTitle}>Bus{"\n"}Ticket</Text>
            <Image source={require("../../../assets/images/ticket-second.webp")} style={styles.cardIllustration} contentFit="contain" />
          </TouchableOpacity>

          <TouchableOpacity style={styles.actionCard} onPress={() => (navigation as any).navigate("Pass")}>
            <Animated.View style={[styles.newBadgeCenter, {
            opacity: blinkAnim
          }]}>
              <Text style={styles.newBadgeText}>New</Text>
            </Animated.View>
            <Text style={styles.actionTitle}>Bus{"\n"}Passes</Text>
            <Image source={require("../../../assets/images/ticket-first.webp")} style={styles.cardIllustration} contentFit="contain" />
          </TouchableOpacity>
        ...
        <View style={styles.section}>
          ...
          {latestTicket ? <TicketCard ticket={latestTicket} onPress={() => navigation.navigate("Ticket", {
          ticket: latestTicket
        })} showTimer={false} largeText={true} showTID={false} /> : <View style={styles.topEmptyCard}>
        ...
        <View style={styles.section}>
          ...
          {latestPass ? <TicketCard ticket={latestPass} onPress={() => (navigation as any).navigate("Ticket", {
          ticket: latestPass
        })} showTimer={false} largeText={true} showTID={false} /> : <TouchableOpacity style={styles.bottomEmptyCard} onPress={() => (navigation as any).navigate("Pass")}>
