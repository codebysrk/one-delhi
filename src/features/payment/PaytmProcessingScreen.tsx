...
export const PaytmProcessingScreen = ({
  formattedTotal
}: PaytmProcessingScreenProps) => {
  ...
  useEffect(() => {
    ...
    const spin = Animated.loop(Animated.timing(paytmSpinAnim, {
      toValue: 1,
      duration: 1200,
      easing: Easing.linear,
      useNativeDriver: true
    }));
    const pulse = Animated.loop(Animated.sequence([Animated.timing(paytmPulseAnim, {
      toValue: 1.12,
      duration: 750,
    ...
    const glow = Animated.loop(Animated.sequence([Animated.timing(paytmGlowAnim, {
      toValue: 1.0,
      duration: 1000,
      easing: Easing.inOut(Easing.ease),
      useNativeDriver: true
  ...
  return <View style={styles.paytmProcessingBox}>
      <StatusBar barStyle="dark-content" backgroundColor="#FFFFFF" translucent={true} />
      <View style={styles.paytmSpinnerContainer}>
        <Animated.View style={[styles.paytmSpinnerGlow, {
        transform: [{
          scale: paytmGlowAnim
        }],
        ...
        <Animated.View style={[styles.paytmSpinnerRing, {
        transform: [{
        ...
        <Animated.View style={[styles.paytmLockIcon, {
        transform: [{
          scale: paytmPulseAnim
        }]
      }]}>
