...
export const PaytmSuccessScreen = ({
  ...
  useEffect(() => {
    ...
    Animated.sequence([Animated.spring(checkmarkScale, {
      toValue: 1,
      friction: 5,
      tension: 50,
    ...
    const loop1 = Animated.loop(Animated.timing(paytmRing1, {
      toValue: 1,
      duration: 1800,
      easing: Easing.out(Easing.quad),
      useNativeDriver: true
    }));
    const loop2 = Animated.loop(Animated.sequence([Animated.delay(600), Animated.timing(paytmRing2, {
      toValue: 1,
      duration: 1800,
      easing: Easing.out(Easing.quad),
      useNativeDriver: true
    })]));
    const loop3 = Animated.loop(Animated.sequence([Animated.delay(1200), Animated.timing(paytmRing3, {
      toValue: 1,
      duration: 1800,
      easing: Easing.out(Easing.quad),
      useNativeDriver: true
  ...
  return <View style={styles.paytmSuccessContainer}>
      ...
      <View style={styles.paytmSuccessTickContainer}>
        {}
        <Animated.View style={[styles.paytmSuccessRing, {
        transform: [{
        ...
        <Animated.View style={[styles.paytmSuccessCircle, {
        transform: [{
      ...
      <Animated.Text style={[styles.paytmSuccessTitle, {
      opacity: detailsOpacity,
      transform: [{
        translateY: paytmTextTranslateY
      }]
    }]}>
        ₹{formattedTotal} Paid Successfully
      </Animated.Text>
      
      <Animated.Text style={[styles.paytmSuccessSubtitle, {
      opacity: detailsOpacity,
      transform: [{
        translateY: paytmTextTranslateY
      }]
      ...
      <Animated.View style={[styles.paytmDetailsCard, {
      opacity: detailsOpacity,
      transform: [{
        ...
        <View style={styles.paytmDetailRow}>
          ...
          <Text style={[styles.paytmDetailVal, {
