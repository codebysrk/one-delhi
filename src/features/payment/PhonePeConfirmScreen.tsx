...
const BankLogo = ({ type }: { type: string | null }) => {
  if (type === "SBI") {
    return (
      <View style={[styles.bankLogoCircle, { backgroundColor: "#1A73E8" }]}>
  ...
  if (type === "HDFC") {
    return (
      <View style={[styles.bankLogoCircle, { backgroundColor: "#004c8f" }]}>
        <SvgXml xml={hdfcSvgXml} width={22} height={22} />
      </View>
    );
  }
  // Central Bank of India logo (Default)
  return (
    <View style={styles.cbiLogoOuter}>
...
export const PhonePeConfirmScreen = ({
  ...
  return (
    <View style={styles.container}>
      ...
      {/* HEADER BAR */}
      <View style={[styles.headerBar, { height: 60 }]}>
      ...
      {showBottomSheet && (
        <View style={styles.backdrop}>
          ...
          <View style={styles.bottomSheet}>
            ...
            {/* SBI Bank Option */}
            <TouchableOpacity
              style={[styles.recommendedCard, selectedBank === "SBI" && styles.recommendedCardActive]}
              ...
              <View style={styles.bankInfoRow}>
                ...
                <View style={styles.checkedContainer}>
                  ...
                  <MaterialCommunityIcons 
                    ...
                    size={20} 
                    color={selectedBank === "SBI" ? "#5f259f" : "#8e8e93"} 
                  />
                </View>
              </View>
            </TouchableOpacity>
            ...
            {/* HDFC Bank Option */}
            <TouchableOpacity
              style={[styles.recommendedCard, selectedBank === "HDFC" && styles.recommendedCardActive]}
              ...
              <View style={styles.bankInfoRow}>
                ...
                <View style={styles.checkedContainer}>
                  ...
                  <MaterialCommunityIcons 
                    ...
                    size={20} 
                    color={selectedBank === "HDFC" ? "#5f259f" : "#8e8e93"} 
                  />
                </View>
              </View>
            </TouchableOpacity>
