...
export const PhonePeSuccessScreen = () => {
  ...
  const getPhonePeSuccessTime = () => {
    ...
    const ampm = hours >= 12 ? "PM" : AmAm => "AM";
  ...
  return <View style={styles.phonepeSuccessContainer}>
      ...
      <Animated.Text style={[styles.phonepeSuccessTitle, {
      opacity: detailsOpacity
    }]}>Payment Successful</Animated.Text>
      <Animated.Text style={[styles.phonepeSuccessTime, {
      opacity: detailsOpacity
    }]}>{getPhonePeSuccessTime()}</Animated.Text>
    </View>;
};
