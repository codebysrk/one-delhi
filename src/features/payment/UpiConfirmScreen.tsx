...
interface UpiConfirmScreenProps {
  selectedApp: "Paytm" | "PhonePe" | "GPay" | "BHIM";
  activeTxnId: string;
  ...
  return <View style={styles.confirmContainer}>
      ...
      <ScrollView contentContainerStyle={styles.confirmContentScroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.confirmTitleRow}>
          ...
          <MaterialCommunityIcons name="check-circle" size={18} color="#00C2FF" style={{
          marginLeft: 4
        }} />
        </View>
        ...
        <View style={styles.gradientRibbonContainer}>
          <LinearGradient colors={["#E9F2FD", "#FDF0F2", "#FEF8E7"]} start={{
          x: 0,
          y: 0
        }} end={{
          x: 1,
        ...
        <View style={styles.hugeAmountContainer}>
          ...
          <Text style={styles.hugeAmountText}>
            {integerPart}
            {decimalPart ? <Text style={styles.paiseText}>.{decimalPart}</Text> : null}
          </Text>
        </View>
      ...
      <View style={styles.confirmBottomContainer}>
        ...
        {}
        <TouchableOpacity style={styles.proceedSecurelyBtn} onPress={() => setShowBankSheet(true)} activeOpacity={0.8}>
          <MaterialCommunityIcons name="shield-check" size={20} color="white" style={{
          marginRight: 8
        }} />
      ...
      {}
      {showBankSheet && <View style={styles.bottomSheetBackdrop}>
          <TouchableOpacity style={styles.bottomSheetDismissArea} activeOpacity={1} onPress={() => setShowBankSheet(false)} />
          <View style={styles.bottomSheetContainer}>
            ...
            <ScrollView style={styles.bankListScroll} showsVerticalScrollIndicator={false}>
              {}
              <TouchableOpacity style={[styles.bankRow, selectedBank === "SBI" && styles.bankRowActive]} onPress={() => setSelectedBank("SBI")} activeOpacity={0.7}>
                ...
                <MaterialCommunityIcons name={selectedBank === "SBI" ? "check-circle" : "circle-outline"} size={22} color={selectedBank === "SBI" ? "#0045A5" : "#9CA3AF"} />
              </TouchableOpacity>

              {}
              <TouchableOpacity style={[styles.bankRow, selectedBank === "HDFC" && styles.bankRowActive]} onPress={() => setSelectedBank("HDFC")} activeOpacity={0.7}>
                <View style={styles.bankRowLeft}>
                  <View style={styles.bankLogoSvgWrapper}>
                ...
                <MaterialCommunityIcons name={selectedBank === "HDFC" ? "check-circle" : "circle-outline"} size={22} color={selectedBank === "HDFC" ? "#0045A5" : "#9CA3AF"} />
              </TouchableOpacity>
              ...
              <TouchableOpacity style={styles.linkAccountRow} activeOpacity={0.7}>
                <MaterialCommunityIcons name="plus" size={22} color="#0056C6" style={{
              marginRight: 12
            }} />
            ...
            {}
            <TouchableOpacity style={[styles.paySecurelyBtn, !selectedBank && styles.paySecurelyBtnDisabled]} onPress={() => {
          if (!selectedBank) {
          ...
          onProceed();
              ...
              <MaterialCommunityIcons name="shield-check" size={20} color={selectedBank ? "white" : "#9CA3AF"} style={{
            marginRight: 8
          }} />
