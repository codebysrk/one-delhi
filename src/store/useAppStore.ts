...
export const useAppStore = create<AppState>()(persist(set => ({
  ...
  setCachedStops: cachedStops => set({
    cachedStops
  }),
  ...
  setShowFooter: show => set({
    showFooter: show
  }),
  setDeviceId: deviceId => set({
    deviceId
  }),
  setLastSeenNotification: timestamp => set({
    lastSeenNotification: timestamp
  }),
  setLatestNotificationTimestamp: timestamp => set({
    latestNotificationTimestamp: timestamp
  }),
  setIsVerifying: isVerifying => set({
    isVerifying
  }),
  setIsAuthReady: isAuthReady => set({
    isAuthReady
  }),
